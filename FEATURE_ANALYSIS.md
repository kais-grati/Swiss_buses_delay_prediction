# Feature Impact Analysis — prev_stop_delay, dist_to_prev_stop & trip_stop_index

**Date:** 2026-05-19
**Goal:** Quantify the impact of lag features and the previously-unused trip_stop_index on model performance
...
![](docs/charts/feature_ablation.png)
...
![](docs/charts/delay_by_stop_position.png)
